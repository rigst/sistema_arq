...
class Proposta(EmpresaModel, Rastreavel):
    ...
    tipo_projeto = models.CharField(
        max_length=20, default="residencial", verbose_name="tipo de projeto"
    )
    hora_tecnica_aplicada = models.DecimalField(
        max_digits=10, decimal_places=2, default=0, verbose_name="hora técnica aplicada"
    )
...
class ItemProposta(EmpresaModel):
    ...
    horas_estimadas = models.DecimalField(
        max_digits=8, decimal_places=2, default=0, verbose_name="horas estimadas"
    )
