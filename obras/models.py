...
class EtapaObra(EmpresaModel):
    ...
    percentual_previsto = models.DecimalField(
        ...
        decimal_places=1,
        default=0,
        help_text="Avanço planejado até hoje (0–100).",
    ...
    percentual_real = models.DecimalField(
        ...
        decimal_places=1,
        default=0,
        help_text="Avanço executado (0–100).",
...
class VisitaTecnica(EmpresaModel, Rastreavel):
    ...
    pendencias = models.TextField(
        blank=True,
        help_text="Pendências a resolver (deixe vazio se ok).",
...
class Medicao(EmpresaModel):
    ...
    percentual_medido = models.DecimalField(
        ...
        decimal_places=1,
        default=0,
        help_text="Avanço verificado nesta medição.",
        verbose_name="percentual medido",
    )
    valor_liberado = models.DecimalField(
        max_digits=14, decimal_places=2, default=0, verbose_name="valor liberado"
    )
