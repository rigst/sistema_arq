...
# WorkingDirectory, que é /var/www/sistema_arq/current.
#
...
# mesmo seria `/run/sistema_arq/gunicorn.ctl` com `RuntimeDirectory=` na unidade,
...
# resolvido na subida.
control_socket = "/home/rod/.gunicorn/sistema_arq.ctl"
