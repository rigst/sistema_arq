...
EMPRESARIAL = {
    ...
    "perguntas": [
        {
            "bloco": "Organização",
            "texto": "Quais equipes e quantas pessoas usarão cada área?",
            "tipo": "texto",
        },
        {
            "bloco": "Organização",
            "texto": "Como será o regime de trabalho?",
            "tipo": "multipla",
            "opcoes": [
                "Presencial",
                "Híbrido",
                "Remoto com estações compartilhadas",
                "Atendimento ao público",
            ],
        },
        {
            "bloco": "Programa",
            "texto": "Quais espaços precisam fazer parte do programa?",
            "tipo": "multipla",
            "opcoes": [
                ...
                "Copa/refeitório",
                "Recepção",
                "Auditório ou treinamento",
            ],
        },
        {
            "bloco": "Tecnologia",
            "texto": "Quais requisitos de infraestrutura são indispensáveis?",
            "tipo": "multipla",
            "opcoes": [
                "Rede e dados",
                "Videoconferência",
        ...
        {
            "bloco": "Identidade",
            "texto": "Que valores da empresa o espaço deve comunicar?",
            "tipo": "texto",
        },
        {
            "bloco": "Operação",
        ...
        {
            "bloco": "Prazo e decisão",
            "texto": "Quais são o prazo, orçamento e responsáveis pelas aprovações?",
            "tipo": "texto",
        },
    ],
}
...
INSTITUCIONAL = {
    ...
    "perguntas": [
        {
            "bloco": "Público",
            "texto": "Quem são os usuários e quais necessidades específicas devem ser atendidas?",
            "tipo": "texto",
        },
        {
            "bloco": "Programa",
            "texto": "Quais atividades e capacidades cada ambiente precisa comportar?",
            "tipo": "texto",
        },
        {
            "bloco": "Acessibilidade",
            "texto": "Quais requisitos de acessibilidade e inclusão são prioritários?",
            "tipo": "multipla",
            "opcoes": [
                "Mobilidade",
                "Sinalização tátil",
        ...
        {
            "bloco": "Normas",
            "texto": "Quais licenças e normas específicas se aplicam?",
            "tipo": "multipla",
            "opcoes": [
                "Aprovação municipal",
                "Corpo de Bombeiros",
        ...
        {
            "bloco": "Gestão",
            "texto": "Quem decide, quem valida tecnicamente e como serão formalizadas as aprovações?",
            "tipo": "texto",
        },
        {
            "bloco": "Recursos",
            "texto": "Quais são a fonte de recursos, o orçamento e o prazo institucional?",
            "tipo": "texto",
        },
    ],
}
...
URBANISMO = {
    ...
    "perguntas": [
        {
            "bloco": "Território",
            "texto": "Qual é a área de intervenção e sua relação com o entorno?",
            "tipo": "texto",
        },
        {
            "bloco": "Base técnica",
            "texto": "Quais levantamentos já estão disponíveis?",
            "tipo": "multipla",
            "opcoes": [
                "Topografia",
                "Cadastro fundiário",
        ...
        {
            "bloco": "Programa",
            "texto": "Quais usos, equipamentos e espaços livres devem ser previstos?",
            "tipo": "texto",
        },
        {
            "bloco": "Mobilidade",
            "texto": "Quais modos e fluxos precisam ser priorizados?",
            "tipo": "multipla",
            "opcoes": [
                "Pedestres",
                "Bicicletas",
        ...
        },
        {
            ...
            "texto": "Quais sistemas precisam ser implantados ou ampliados?",
            "tipo": "multipla",
            "opcoes": [
                "Drenagem",
                "Água e esgoto",
        ...
        {
            "bloco": "Participação",
            "texto": "Quais atores participam das decisões e como ocorrerá a consulta pública?",
            "tipo": "texto",
        },
        {
            "bloco": "Implantação",
            "texto": "Quais são as etapas, orçamento, licenças e horizonte de implantação?",
            "tipo": "texto",
        },
    ],
}
